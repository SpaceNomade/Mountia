...
<link href="https://fonts.googleapis.com/css?family=Cookie|Courgette|Dancing+Script|Great+Vibes|Kalam|Kaushan+Script|Marck+Script|Merienda|Merriweather|Pacifico|Satisfy" rel=stylesheet>
...
<script>var script=document.createElement("script"),body=document.getElementsByTagName("body")[0],toggle=false;script.type="text/javascript";script.addEventListener("load",function(){new KonamiCode(function(){if(toggle){toggle=false;body.style="overflow-x: hidden;transition: transform 2s ease;transform: rotate(0deg)"}else{toggle=true;body.style="overflow-x: hidden;transition: transform 2s ease;transform: rotate(180deg)"}})});script.src="https://cdn.rawgit.com/Haeresis/konami-code-js/master/src/konami-code.js";body.appendChild(script);</script>
<script src=../js/creative.min.js></script>
<script src=../js/Chart.js></script>
<script>var ctx=document.getElementById("myStatTotal").getContext("2d");var myStatTotal=new Chart(ctx,{type:"radar",data:{labels:["Charisme","Force","Endurance","Dextérité","Agilité","Intelligence","Sagesse","Potentiel","Initiative","Chance","Froid","Chaleur","Maladie","Boisson","Charme","Peur","Sommeil","Douleur"],datasets:[{backgroundColor:"rgba(69, 125, 187, 0.75)",pointBackgroundColor:"rgba(128, 21, 21)",borderColor:"rgb(118,150,0)",data:[<?php echo htmlspecialchars($charisme);?>,<?php echo htmlspecialchars($force);?>,<?php echo htmlspecialchars($endurance);?>,<?php echo htmlspecialchars($dexterité);?>,<?php echo htmlspecialchars($agilité);?>,<?php echo htmlspecialchars($intelligence);?>,<?php echo htmlspecialchars($sagesse);?>,<?php echo htmlspecialchars($potentiel);?>,<?php echo htmlspecialchars($initiative);?>,<?php echo htmlspecialchars($chance);?>,<?php echo htmlspecialchars($froid);?>,<?php echo htmlspecialchars($chaleur);?>,<?php echo htmlspecialchars($maladie);?>,<?php echo htmlspecialchars($boisson);?>,<?php echo htmlspecialchars($charme);?>,<?php echo htmlspecialchars($peur);?>,<?php echo htmlspecialchars($sommeil);?>,<?php echo htmlspecialchars($douleur);?>],}]},options:{legend:{display:false,},scale:{ticks:{min:0,}}}});var ctx=document.getElementById("myBarChart").getContext("2d");var myBarChart=new Chart(ctx,{type:"horizontalBar",data:{labels:["Vie","Spiritualité","Mana"],datasets:[{data:[<?php echo htmlspecialchars($pdv);?>,<?php echo htmlspecialchars($pds);?>,<?php echo htmlspecialchars($pdm);?>],backgroundColor:["rgba(148,6,2,0.75)","rgba(118, 150, 0, 0.75)","rgba(69,125,187,0.75)",],borderColor:["rgb(148,6,2)","rgb(118,150,0)","rgb(69,125,187)"],},]},options:{legend:{display:false,},scales:{xAxes:[{ticks:{beginAtZero:true}}]}}});</script>
</body>
</html>