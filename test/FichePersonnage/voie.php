...
if ($nomPersonnage == "orochi" || $nomPersonnage == "orochiDragon" ) {
    ...
    $voie1Niveau2 = '<img src="../img/voies/forge/rang_2.png" alt="" title="Niveau 1" width="50px">';
    $voie1DescriptionNiveau2 = "O";
    $voie1Niveau3 = '<img src="../img/voies/forge/rang_3.png" alt="" title="Niveau 1" width="50px">';
    ...
    $voie2Niveau2 = '<img src="../img/voies/armurier/rang_2.png" alt="" title="Niveau 1" width="50px">';
    ...
    $voie1DescriptionNiveau1 = "O";
    $voie1Niveau2 = '<img src="../img/voies/guerrier/rang_2.png" alt="" title="Niveau 1" width="50px">';
    $voie1DescriptionNiveau2 = "O";
    $voie1Niveau3 = '<img src="../img/voies/guerrier/rang_3.png" alt="" title="Niveau 1" width="50px">';
    $voie1DescriptionNiveau3 = "O";

    $voie2Nom = "Chevalier Noir";
    $voie2Niveau1 = '<img src="../img/voies/chevalier_noir/rang_1.png" alt="" title="Niveau 1" width="50px">';
    $voie2DescriptionNiveau1 = "O";
    $voie2Niveau2 = '<img src="../img/voies/chevalier_noir/rang_2.png" alt="" title="Niveau 1" width="50px">';
    $voie2DescriptionNiveau2 = "O";
    ...
    $voie3Niveau2 = "";//'<img src="../img/voies/mineur/rang_2.png" alt="" title="Niveau 1" width="50px">';
    $voie3DescriptionNiveau2 = "";
