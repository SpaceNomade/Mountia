...
if ($nomPersonnage == "orochi" || $nomPersonnage == "orochiDragon") {
    ...
    $tatouage9Quantité = "X";
    $tatouage9Taille = "X";
    $tatouage9Emplacement = "X";
    $tatouage9Type = "X";
    $tatouage9Effet = "X";

    $tatouage10Nom = "X";
    $tatouage10Rang = "X";
    $tatouage10Quantité = "X";
    $tatouage10Taille = "X";
    $tatouage10Emplacement = "X";
    $tatouage10Type = "X";
    $tatouage10Effet = "X";
    ...
    echo "<script>console.log('Inventaire de Barfero le Possédée importer');</script>";
